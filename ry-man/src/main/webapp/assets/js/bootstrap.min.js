...
+function($) {
	...
	Alert.prototype.close = function(e) {
		...
		$.support.transition && $parent.hasClass('fade') ? $parent.one($.support.transition.end, removeElement)
...
+function($) {
	...
	Modal.prototype.show = function(_relatedTarget) {
		...
		this.backdrop(function() {
					...
					if (!that.$element.parent().length) {
						that.$element.appendTo(document.body) // don't move
						// modals dom
						// position
					}
					...
					transition ? that.$element.find('.modal-dialog') // wait
							// for
							// modal
							// to
							// slide
	...
	Modal.prototype.hide = function(e) {
		...
		$.support.transition && this.$element.hasClass('fade') ? this.$element.one($.support.transition.end,
...
+function($) {
	...
	Tooltip.prototype.show = function() {
		...
		if (this.hasContent() && this.enabled) {
			...
			var placement = typeof this.options.placement == 'function' ? this.options.placement.call(this, $tip[0],
...
+function($) {
	...
	Popover.prototype.setContent = function() {
		...
		if (this.options.disapper) {
			setTimeout(function() {
                $tip.hide();
					}, this.options.disapper);
		}
	}
...
+function($) {
	...
	var Affix = function(element, options) {
		...
		this.$window = $(window).on('scroll.bs.affix.data-api', $.proxy(this.checkPosition, this)).on(
				'click.bs.affix.data-api', $.proxy(this.checkPositionWithEventLoop, this))
	...
	Affix.prototype.checkPosition = function() {
		...
		var affix = this.unpin != null && (scrollTop + this.unpin <= position.top) ? false : offsetBottom != null
