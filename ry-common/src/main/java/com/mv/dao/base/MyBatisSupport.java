...
abstract class MyBatisSupport {
	...
	protected int insert(String statement,Object parameter){
		...
		try {
			...
			throw new RuntimeException("Mybatis执行新增异常", ex);
		}
		return res;
	}
	...
	protected int delete(String statement,Object parameter){
		...
		try {
			...
			throw new RuntimeException("Mybatis执行删除异常", ex);
		}
		return res;
	}
	...
	protected int update(String statement,Object parameter){
		...
		try {
			...
			throw new RuntimeException("Mybatis执行更新异常", ex);
		}
		return res;
	}
	...
	protected <T> T select(String statement,Object parameter) {
		...
		try {
			...
			throw new RuntimeException("Mybatis执行单条查询异常",ex);
		}
		return obj;
	}
	...
	protected <T> List<T> selectList(String statement,Object parameter) {
		...
		try {
			...
			throw new RuntimeException("Mybatis执行列表查询异常",ex);
		}
		return list;
	}
	...
	protected <K, V> Map<K, V> selectMap(String statement,Object parameter, String mapKey) {
		...
		try {
			...
			throw new RuntimeException("Mybatis执行Map查询异常",ex);
		}
		return map;
	}
}
